  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
	  ...
	  <div class="form-group">
		...
		<span id="sprytf_section">
        <input name="section" class="form-control input-sm" placeholder="Section" id="section"></input>
		<span class="textareaRequiredMsg">Section is required.</span>
	  ...
	  <div class="form-group">
		...
		<span id="sprytf_program">
        <input type="text" name="program" class="form-control input-sm"  placeholder="progam" id="progam">
		<span class="textfieldRequiredMsg">Program is required.</span>
		</span>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
            ...
            <input type="text" name="rtime" class="form-control" placeholder="HH-HH">
...
var sprytf_rtime 	= new Spry.Widget.ValidationTextField("sprytf_rtime", "time", {hint:"i.e HH - HH", useCharacterMasking: true, validateOn:["blur", "change"]});
